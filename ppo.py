...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(f"ppo_runs/{run_name}")
    ...
    num_envs = 8
    envs = gym.vector.SyncVectorEnv([make_env("MiniGrid-Dynamic-Obstacles-Random-5x5-v0", 1+ i, i) for i in range(num_envs)])
    ...
    for update in range(1, num_updates+1):
        ...
        for epoch in range(epochs):
            ...
            for start in range(0, batch_size, minibatch_size):
                ...
                _, mb_newlogprobs, mb_entropies, newvalue = agent.get_action_and_value(b_obs[mb_inds], b_actions.squeeze()[mb_inds])
